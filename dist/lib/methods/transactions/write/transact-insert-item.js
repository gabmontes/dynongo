...
exports.TransactInsertItem = void 0;
const util_dynamodb_1 = require("@aws-sdk/util-dynamodb");
const transact_method_1 = require("../transact-method");
class TransactInsertItem extends transact_method_1.TransactMethod {
    constructor(query) {
        super();
        this.query = query;
    }
...
exports.TransactInsertItem = TransactInsertItem;
//# sourceMappingURL=transact-insert-item.js.map